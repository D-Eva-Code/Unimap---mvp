...
//   autoplay={{ delay: 3000 }}
//   pagination={{ clickable: true }}
//   style={{ marginBottom: "40px", borderRadius: "20px", height: "300px" }}
// >
...
//           }}
//         >
//           <h2 style={{ fontSize: "28px", margin: "0 0 8px 0" }}>{meal.name}</h2>
//           <p style={{ fontSize: "18px", margin: "0 0 12px 0" }}>{meal.price}</p>
//           <button
//             style={{
//               padding: "10px 24px",
//               borderRadius: "12px",
